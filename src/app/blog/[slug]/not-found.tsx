...
// Página 404 para artículos no encontrados
// =========================================================
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#050505] px-6 text-center text-white">
      ...
      <p className="mt-4 max-w-md text-base leading-7 text-white/60">
        El artículo que buscas no existe, fue retirado o aún no ha sido publicado.
        Regresa al blog para explorar el contenido disponible.
      </p>
