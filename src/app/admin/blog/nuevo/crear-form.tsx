...
// src/app/admin/blog/nuevo/crear-form.tsx
// Client Component: formulario de creación de artículo
// =========================================================

'use client'

import { useActionState, useState, useCallback } from 'react'
import { crearArticulo, type CrearArticuloState } from './actions'
...
export function CrearArticuloForm() {
  const [state, formAction, isPending] = useActionState<CrearArticuloState | null, FormData>(
    crearArticulo,
    null
  )
    ...
    <form action={formAction}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
        <div className="md:col-span-2">
          ...
          <input
            ...
            placeholder="Ej. Una casa para la memoria del archivo"
        ...
        <div>
          ...
          <input
            ...
            placeholder="Ej. Crónica del archivo"
            disabled={isPending}
            className={inputClass}
          />
        ...
        <div>
          ...
          <input
            ...
            placeholder="Legado Patrimonial WSS"
            disabled={isPending}
            className={inputClass}
          />
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            ...
            placeholder="Resumen corto del artículo (aparece en tarjetas de vista previa)"
            disabled={isPending}
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Escribe el cuerpo del artículo en formato Markdown..."
          disabled={isPending}
