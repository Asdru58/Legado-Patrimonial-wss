...
// src/app/admin/estudios/nueva/crear-form.tsx
// Client Component: formulario de creación de colección
//
...
import { crearColeccion, type CrearColeccionState } from './actions'
...
export function CrearColeccionForm() {
  const [state, formAction, isPending] = useActionState<CrearColeccionState | null, FormData>(
    crearColeccion,
    null
  )
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
        <div className="md:col-span-2">
          ...
          <input
            ...
            placeholder="Ej. Las Siete Edades"
