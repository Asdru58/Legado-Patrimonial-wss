...
// src/app/admin/podcast/[id]/editar/editar-form.tsx
// Client Component: formulario de edición de episodio
// =========================================================

'use client'

import { useActionState, useState, useCallback } from 'react'
import { editarEpisodio, type EditarEpisodioState } from './actions'
import type { Episodio } from '@/lib/services/podcast'
...
export function EditarEpisodioForm({ episodio }: { episodio: Episodio }) {
  const [state, formAction, isPending] = useActionState<EditarEpisodioState | null, FormData>(
    editarEpisodio,
    null
  )
  const [slugManual, setSlugManual] = useState(true) // En edición, el slug ya existe
  const [slug, setSlug] = useState(episodio.slug)
    ...
    <form action={formAction}>
      ...
      {state?.success && (
        ...
        >
          ...
          Episodio actualizado correctamente.
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
        ...
        <div>
          ...
          <input
            ...
            type="number"
            min={1}
            defaultValue={episodio.temporada}
            disabled={isPending}
            className={inputClass}
          />
        ...
        <div>
          ...
          <input
            ...
            type="number"
            min={1}
            defaultValue={episodio.numero_episodio ?? ''}
            disabled={isPending}
            className={inputClass}
          />
        ...
        <div>
          ...
          <input
            ...
            type="date"
            defaultValue={episodio.fecha_publicacion ?? ''}
            disabled={isPending}
        ...
        <div>
          ...
          <input
            ...
            type="number"
            min={1}
            defaultValue={episodio.duracion_minutos ?? ''}
            disabled={isPending}
            className={inputClass}
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
        <div>
          ...
          <input
            ...
            defaultValue={episodio.tema_doctrinal ?? ''}
            disabled={isPending}
            className={inputClass}
          />
        ...
        <div>
          ...
          <input
            ...
            defaultValue={episodio.texto_biblico_base ?? ''}
            disabled={isPending}
            className={inputClass}
          />
        ...
        <div>
          ...
          <input
            ...
            defaultValue={episodio.participantes ?? ''}
            disabled={isPending}
            className={inputClass}
          />
        ...
        <div>
          ...
          <input
            ...
            defaultValue={episodio.conferencia_fuente ?? ''}
            disabled={isPending}
            className={inputClass}
          />
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            ...
            defaultValue={episodio.extracto_referenciado ?? ''}
            disabled={isPending}
            className={textareaClass}
          />
      ...
      <div className="grid grid-cols-1 gap-y-5">
        <div>
          ...
          <input
            ...
            defaultValue={episodio.audio_url ?? ''}
            disabled={isPending}
            className={inputClass}
          />
        ...
        <div>
          ...
          <input
            ...
            defaultValue={episodio.video_url ?? ''}
            disabled={isPending}
            className={inputClass}
          />
          <p className="mt-1.5 font-[family-name:var(--font-dm-sans)] text-xs text-white/40">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:gap-8">
        <label className="inline-flex items-center gap-3 cursor-pointer">
          <input
            type="checkbox"
            name="published"
            defaultChecked={episodio.published}
        ...
        <label className="inline-flex items-center gap-3 cursor-pointer">
          <input
            type="checkbox"
            name="destacado"
            defaultChecked={episodio.destacado}
            className="w-4 h-4 rounded border-white/20 bg-white/5 text-[#C8A843] focus:ring-[#C8A843]/30"
          />
          <span className="font-[family-name:var(--font-dm-sans)] text-sm text-white/70">
