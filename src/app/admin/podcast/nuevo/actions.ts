...
// src/app/admin/podcast/nuevo/actions.ts
// Server Action: crear episodio
//
...
export interface CrearEpisodioState {
  error: string | null
...
export async function crearEpisodio(
  _prevState: CrearEpisodioState | null,
  formData: FormData
): Promise<CrearEpisodioState> {
  ...
  if (insertError) {
    console.error('crearEpisodio insertError:', insertError)
    ...
    return {
      error: 'No fue posible guardar el episodio.',
      fieldErrors: {},
    }
  }
